...
var Button = new RightJS.Wrapper(RightJS.Element, {
   ...
   */
  disable: function() {
    return this.addClass('right-button-disabled');
  },
   ...
   */
  enable: function() {
    return this.removeClass('right-button-disabled');
  },
   ...
   */
  disabled: function() {
    return this.hasClass('right-button-disabled');
  },
